...
public class Geometric {
     ...
     * 计算两个线段的交点坐标
     * 前提：先排除两条直线平行的情况！
     * 采用参数方程表示一条直线   \ x = x1 + t1(x2 - x1)
     * \ y = y1 + t1(y2 - y1)
     * 交点在线段上：t1∈[0, 1] 并且 t2∈[0, 1]
     *
     * @param start1 线段 1 的起始坐标
     * @param end1   线段 1 的终点坐标
     * @param start2 线段 2 的起始坐标
     * @param end2   线段 2 的终点坐标
     * @return
     */
    public double[] intersection(int[] start1, int[] end1, int[] start2, int[] end2) {
        ...
        return hasResult ? ans : new double[0];
    }
